...
const CountrySelector = ({ toggleCountry, activeCountry, activeCountryCode, fetchQualData, fetchQuantData }) => {
  return (
    <div>
      <h1 className="country-name-header">{activeCountry}</h1>
      <span className="country-selector-span">
        <select className="CountrySelector" onChange={toggleCountry} value={activeCountryCode}>
        ...
        <RaisedButton
          primary={true}
          onClick={() => fetchQuantData(activeCountryCode.slice(-3))}
          label="View Quantitative Data"
        />
        <RaisedButton
          primary={true}
          onClick={() => fetchQualData(activeCountryCode.slice(0, 2))}
...
CountrySelector.propTypes = {
  ...
  activeCountryCode: React.PropTypes.string.isRequired,
